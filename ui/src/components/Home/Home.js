        ...
        <section className="section-3 container-fluid p-0 text-center">
          <div className="row">
            <div className="col-md-12 col-sm-12">
              ...
              <p>
                Lorem ipsum dolor, sit elit. Eum exercitationem alias perspiciatis omnis quod possimus odit
                voluptatum! Sunt ea  praesentium, tenetur doloribus animi obcaecati, sint nemo quae laudantium iusto unde
